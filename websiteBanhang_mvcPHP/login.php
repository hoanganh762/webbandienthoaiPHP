    ...
    <div class="content">
    	 <div class="login_panel">
        	...
        	<form action="" method="post">
                 ...
                 <p class="note">Quên tài khoản hoặc mật khẩu <a href="#">ở đây</a></p>
    	...
    	<div class="register_account">
    		...
    		<form action="" method="POST">
		    		...
		    		<div>
					<select id="country" name="country" onchange="change_country(this.value)" class="frm-field required" style=" width: 338px;">	
						
							<option value="null">Nhập thành phố</option>   
